export LLM_PROVIDER=anthropic  # 'deepseek', 'openai', 'anthropic', 'octoai'
...
export OCTOAI_MODEL=meta-llama-3.1-405b-instruct # meta-llama-3.1-405b-instruct, meta-llama-3.1-70b-instruct
...
export CODE_OUTPUT_DIR=$(pwd)/packages
